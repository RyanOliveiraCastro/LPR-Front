...
<main>
    <div class="buttons">
        ...
        <a href="loginFuncionario" id="funcionario" type="button">FUNCIONARIO</a>
        <a href="#" class="active" id="protetico" type="button">PROTETICO</a>
    </div>

    <div class="logo">
        <img src="assets/imagens/logo.png">
    </div>
    <form action="logarProtetico" method="post">
        <div class="inputs">
