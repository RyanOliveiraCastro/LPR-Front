...
<html lang="pt-br">
<head>
    <title>Transporte Visualizar</title>
    <meta charset="utf-8">
    ...
    <form id="formId" action="transporteAtualizar" method="post">
        <div class="inputs">
            ...
            <label>Forma de Transporte
                <select id="listFormaTransporte" name="nFormaTransporte" readonly="readonly">
                    <?php $servicoController->selectTransporte() ?>
                </select>
            </label>
            <label for="valor">Valor
                <input id="valor" placeholder="valor" name="nValor" type="number" readonly="readonly">
            </label>
