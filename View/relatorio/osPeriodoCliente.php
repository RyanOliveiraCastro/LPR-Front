...
<header>
    <ul>
        ...
        <li class="title">OS POR PERIODO POR CLIENTE</li>
    </ul>
</header>
...
<main>
    <form id="formId" method="post">
        <div class="inputs">
            ...
            <label for="entrega">Data Inicio
                <input id="iDtIni" name='nDtIni' placeholder="Data Inicio" type="date" required>
            </label>
            <label for="entrega">Data Fim
                <input id="iDtFim" name='nDtFim' placeholder="Data Fim" type="date" required>
            </label>

            <input id="pesquisa" type="button" value="Pesquisar" required>
        </div>
    </form>
...
<script src="<?=URL_BASE . '/assets/js/OsPeriodoCliente.js'?>" ></script>
</body>
</html>