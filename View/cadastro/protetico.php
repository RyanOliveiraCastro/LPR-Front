...
<main>
    ...
    <form id="formId" action="proteticoInserir" method="post">
        <div class="inputs">
            <label>Protetico</label>
            <select id="listProtetico" name="nListProtetico">
                <option value=0>Novo Protetico</option>
...
<script src="../assets/js/jquery-3.5.0.min.js"></script>
<script src="../assets/js/protetico.js"></script>
</body>
</html>