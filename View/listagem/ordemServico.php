...
namespace LPR\view;
use LPR\Controller\ListagemController;
...
<header>
    <ul>
        <a href="../listagem"><li class="Menu"><i class="fas fa-arrow-left"></i></li></a>
        <li class="title">Listagem ORDEM DE SERVICO</li>
    </ul>
</header>

<main>
    <?php
    $listagemController->listOrdemServico();
    ?>
</main>
<footer>
    <ul>
